...
# Variabel untuk menyimpan dataframe
df = None

# Coba membaca file dengan berbagai nama
...
if df is None:
    print("Could not find the salary dataset. Please check the file name and location.")
    exit()

# Cetak informasi dasar tentang dataset
print("\nDataset Information:")
print(df.info())
